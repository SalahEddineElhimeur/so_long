...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/12 00:46:15 by sel-hime          #+#    #+#             */
/*   Updated: 2025/04/20 17:54:10 by sel-hime         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	func(t_game *game)
{
	...
	if (game->data.flag == 1)
	{
		...
		game->enemy_img = mlx_xpm_file_to_image(game->mlx, "textures/e2.xpm",
				(int [1]){0}, (int [1]){0});
	}
	else if (game->data.flag == 2)
	{
		game->data.flag = 0;
		mlx_destroy_image(game->mlx, game->enemy_img);
		game->enemy_img = mlx_xpm_file_to_image(game->mlx, "textures/e3.xpm",
				(int [1]){0}, (int [1]){0});
	}
	else
	{
		game->data.flag = 1;
		mlx_destroy_image(game->mlx, game->enemy_img);
		game->enemy_img = mlx_xpm_file_to_image(game->mlx, "textures/e1.xpm",
				(int [1]){0}, (int [1]){0});
	}
	render_map(game);
	return (0);
...
static void	start_game(t_game *game)
{
	...
	mlx_loop_hook(game->mlx, func, game);
	mlx_loop(game->mlx);
}
