...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/12 00:46:13 by sel-hime          #+#    #+#             */
/*   Updated: 2025/04/19 21:16:02 by sel-hime         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	check_img_init(t_game *game)
{
	if (!game->floor_img || !game->player_img_left || !game->player_img_right
		|| !game->player_img_up || !game->player_img_down || !game->enemy_img
		|| !game->collect_img || !game->wall_img || !game->exit_on_img)
	{
...
void	img_init(t_game *game)
{
	...
	game->enemy_img = mlx_xpm_file_to_image(game->mlx, "textures/e1.xpm", &w,
			&h);
